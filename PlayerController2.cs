...
public class PlayerController2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.director = GameObject.Find("EndDirector");
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.gameObject.tag == "Kinniku")//筋肉と接触
        {
            ...
            this.generator.GetComponent<ItemGenerator2>().SetParameter2(span - 0.05f, speed);
        ...
        if (other.gameObject.tag == "Hana")//ハナちゃんと接触
        {
            ...
            this.generator.GetComponent<ItemGenerator2>().SetParameter2(span - 0.01f, speed);
            this.director.GetComponent<EndDirector>().SetScore();
        }
